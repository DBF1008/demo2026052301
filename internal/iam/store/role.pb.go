...
const file_controller_storage_iam_store_v1_role_proto_rawDesc = "" +
	"\n" +
	"*controller/storage/iam/store/v1/role.proto\x12\x1fcontroller.storage.iam.store.v1\x1a*controller/custom_options/v1/options.proto\x1a/controller/storage/timestamp/v1/timestamp.proto\"\xe0\x02\n" +
	"\x04Role\x12\x1b\n" +
	...
	"updateTime\x12\x18\n" +
	"\aversion\x18F \x01(\rR\aversionJ\x04\bP\x10QB8Z6github.com/hashicorp/boundary/internal/iam/store;storeb\x06proto3"

var (
	file_controller_storage_iam_store_v1_role_proto_rawDescOnce sync.Once
	file_controller_storage_iam_store_v1_role_proto_rawDescData []byte
)
...
func file_controller_storage_iam_store_v1_role_proto_rawDescGZIP() []byte {
	file_controller_storage_iam_store_v1_role_proto_rawDescOnce.Do(func() {
		file_controller_storage_iam_store_v1_role_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_controller_storage_iam_store_v1_role_proto_rawDesc), len(file_controller_storage_iam_store_v1_role_proto_rawDesc)))
	})
...
var file_controller_storage_iam_store_v1_role_proto_goTypes = []any{
...
func file_controller_storage_iam_store_v1_role_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_controller_storage_iam_store_v1_role_proto_rawDesc), len(file_controller_storage_iam_store_v1_role_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
