...
const file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDesc = "" +
	"\n" +
	"6controller/storage/iam/store/v1/role_grant_scope.proto\x12\x1fcontroller.storage.iam.store.v1\x1a/controller/storage/timestamp/v1/timestamp.proto\"\xa5\x01\n" +
	"\x0eRoleGrantScope\x12K\n" +
	"\vcreate_time\x18\x01 \x01(\v2*.controller.storage.timestamp.v1.TimestampR\n" +
	"createTime\x12\x17\n" +
	"\arole_id\x18\x02 \x01(\tR\x06roleId\x12-\n" +
	"\x13scope_id_or_special\x18\x03 \x01(\tR\x10scopeIdOrSpecialB8Z6github.com/hashicorp/boundary/internal/iam/store;storeb\x06proto3"

var (
	file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDescOnce sync.Once
	file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDescData []byte
)
...
func file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDescGZIP() []byte {
	file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDescOnce.Do(func() {
		file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDesc), len(file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDesc)))
	})
...
var file_controller_storage_iam_store_v1_role_grant_scope_proto_goTypes = []any{
...
func file_controller_storage_iam_store_v1_role_grant_scope_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDesc), len(file_controller_storage_iam_store_v1_role_grant_scope_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
