...
var filter_PolicyService_UpdatePolicy_0 = &utilities.DoubleArray{Encoding: map[string]int{"item": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
...
func RegisterPolicyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PolicyServiceServer) error {
	mux.Handle(http.MethodGet, pattern_PolicyService_GetPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_PolicyService_GetPolicy_0(annotatedContext, mux, outboundMarshaler, w, req, response_PolicyService_GetPolicy_0{resp.(*GetPolicyResponse)}, mux.GetForwardResponseOptions()...)
	})
	...
	mux.Handle(http.MethodPost, pattern_PolicyService_CreatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_PolicyService_CreatePolicy_0(annotatedContext, mux, outboundMarshaler, w, req, response_PolicyService_CreatePolicy_0{resp.(*CreatePolicyResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodPatch, pattern_PolicyService_UpdatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_PolicyService_UpdatePolicy_0(annotatedContext, mux, outboundMarshaler, w, req, response_PolicyService_UpdatePolicy_0{resp.(*UpdatePolicyResponse)}, mux.GetForwardResponseOptions()...)
	})
...
func (m response_PolicyService_CreatePolicy_0) XXX_ResponseBody() interface{} {
	response := m.CreatePolicyResponse
	return response.Item
}
...
func (m response_PolicyService_UpdatePolicy_0) XXX_ResponseBody() interface{} {
	response := m.UpdatePolicyResponse
	return response.Item
}
