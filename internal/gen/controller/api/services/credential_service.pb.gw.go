...
var filter_CredentialService_ListCredentials_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
var filter_CredentialService_UpdateCredential_0 = &utilities.DoubleArray{Encoding: map[string]int{"item": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
...
func RegisterCredentialServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CredentialServiceServer) error {
	mux.Handle(http.MethodGet, pattern_CredentialService_GetCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_CredentialService_GetCredential_0(annotatedContext, mux, outboundMarshaler, w, req, response_CredentialService_GetCredential_0{resp.(*GetCredentialResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_CredentialService_ListCredentials_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodPost, pattern_CredentialService_CreateCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		forward_CredentialService_CreateCredential_0(annotatedContext, mux, outboundMarshaler, w, req, response_CredentialService_CreateCredential_0{resp.(*CreateCredentialResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodPatch, pattern_CredentialService_UpdateCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		forward_CredentialService_UpdateCredential_0(annotatedContext, mux, outboundMarshaler, w, req, response_CredentialService_UpdateCredential_0{resp.(*UpdateCredentialResponse)}, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodDelete, pattern_CredentialService_DeleteCredential_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
// "CredentialServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
...
func (m response_CredentialService_GetCredential_0) XXX_ResponseBody() interface{} {
	response := m.GetCredentialResponse
...
func (m response_CredentialService_CreateCredential_0) XXX_ResponseBody() interface{} {
	response := m.CreateCredentialResponse
	return response.Item
}
...
func (m response_CredentialService_UpdateCredential_0) XXX_ResponseBody() interface{} {
	response := m.UpdateCredentialResponse
	return response.Item
}
