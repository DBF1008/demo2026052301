...
const file_controller_storage_kms_store_v1_audit_key_proto_rawDesc = "" +
	"\n" +
	"/controller/storage/kms/store/v1/audit_key.proto\x12\x1fcontroller.storage.kms.store.v1\x1a/controller/storage/timestamp/v1/timestamp.proto\"\x96\x01\n" +
	"\bAuditKey\x12\x1d\n" +
	"\n" +
	"private_id\x18\n" +
	...
	"createTime\"\x91\x02\n" +
	"\x0fAuditKeyVersion\x12\x1d\n" +
	"\n" +
	"private_id\x18\n" +
	" \x01(\tR\tprivateId\x12 \n" +
	"\faudit_key_id\x18\x14 \x01(\tR\n" +
	"auditKeyId\x12-\n" +
...
var (
	...
	file_controller_storage_kms_store_v1_audit_key_proto_rawDescData []byte
)
...
func file_controller_storage_kms_store_v1_audit_key_proto_rawDescGZIP() []byte {
	file_controller_storage_kms_store_v1_audit_key_proto_rawDescOnce.Do(func() {
		file_controller_storage_kms_store_v1_audit_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_controller_storage_kms_store_v1_audit_key_proto_rawDesc), len(file_controller_storage_kms_store_v1_audit_key_proto_rawDesc)))
	})
...
var file_controller_storage_kms_store_v1_audit_key_proto_goTypes = []any{
...
func file_controller_storage_kms_store_v1_audit_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_controller_storage_kms_store_v1_audit_key_proto_rawDesc), len(file_controller_storage_kms_store_v1_audit_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
