...
const file_controller_storage_kms_store_v1_session_key_proto_rawDesc = "" +
	"\n" +
	"1controller/storage/kms/store/v1/session_key.proto\x12\x1fcontroller.storage.kms.store.v1\x1a/controller/storage/timestamp/v1/timestamp.proto\"\x98\x01\n" +
	"\n" +
	"SessionKey\x12\x1d\n" +
	"\n" +
	"private_id\x18\n" +
	...
	"createTime\"\x97\x02\n" +
	"\x11SessionKeyVersion\x12\x1d\n" +
	"\n" +
	"private_id\x18\n" +
	" \x01(\tR\tprivateId\x12$\n" +
	"\x0esession_key_id\x18\x14 \x01(\tR\fsessionKeyId\x12-\n" +
...
var (
	...
	file_controller_storage_kms_store_v1_session_key_proto_rawDescData []byte
)
...
func file_controller_storage_kms_store_v1_session_key_proto_rawDescGZIP() []byte {
	file_controller_storage_kms_store_v1_session_key_proto_rawDescOnce.Do(func() {
		file_controller_storage_kms_store_v1_session_key_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_controller_storage_kms_store_v1_session_key_proto_rawDesc), len(file_controller_storage_kms_store_v1_session_key_proto_rawDesc)))
	})
...
var file_controller_storage_kms_store_v1_session_key_proto_goTypes = []any{
...
func file_controller_storage_kms_store_v1_session_key_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_controller_storage_kms_store_v1_session_key_proto_rawDesc), len(file_controller_storage_kms_store_v1_session_key_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
