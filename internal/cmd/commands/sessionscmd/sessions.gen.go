...
func (c *Command) Run(args []string) int {
	...
	var readResult *sessions.SessionReadResult

	var listResult *sessions.SessionListResult
...
var (
	...
	executeExtraActions      = func(_ *Command, inResp *api.Response, inItem *sessions.Session, inItems []*sessions.Session, inErr error, _ *sessions.Client, _ uint32, _ []sessions.Option) (*api.Response, *sessions.Session, []*sessions.Session, error) {
