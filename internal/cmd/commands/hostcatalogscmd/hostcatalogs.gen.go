...
func (c *Command) Run(args []string) int {
	...
	c.plural = "host catalog"
	switch c.Func {
	case "list":
		c.plural = "host catalogs"
	}
	...
	var items []*hostcatalogs.HostCatalog

	var readResult *hostcatalogs.HostCatalogReadResult

	var deleteResult *hostcatalogs.HostCatalogDeleteResult

	var listResult *hostcatalogs.HostCatalogListResult
...
var (
	...
	extraFlagsHandlingFunc   = func(*Command, *base.FlagSets, *[]hostcatalogs.Option) bool { return true }
	executeExtraActions      = func(_ *Command, inResp *api.Response, inItem *hostcatalogs.HostCatalog, inItems []*hostcatalogs.HostCatalog, inErr error, _ *hostcatalogs.Client, _ uint32, _ []hostcatalogs.Option) (*api.Response, *hostcatalogs.HostCatalog, []*hostcatalogs.HostCatalog, error) {
