...
func (n UserListResult) GetListToken() string {
	return n.ListToken
}
...
func (c *Client) List(ctx context.Context, scopeId string, opt ...Option) (*UserListResult, error) {
	...
	slices.SortFunc(allItems, func(i, j *User) int {
...
func (c *Client) ListNextPage(ctx context.Context, currentPage *UserListResult, opt ...Option) (*UserListResult, error) {
	if currentPage == nil {
